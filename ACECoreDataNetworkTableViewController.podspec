#
#  Be sure to run `pod spec lint ACECoreDataNetworkTableViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "Classes", "ACECoreDataNetworkTableViewController/*.{h,m}"
